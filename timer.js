...
var imageWork = "pic2.jpg";
var imageStart = "pic1.jpg";
...
function setWorkMode() {
  ...
  document.getElementById("cont").style.background = "#ecfdf8";
...
function setMicroBreakMode() {
  ...
  document.getElementById("demo3_wm").innerHTML =
    "Relax!";
  document.getElementById("cont").style.background = "#f0fdfa";
  document.getElementById("cont").style.backgroundImage = "none";
}
...
function setDefaultMode() {
  ...
  document.getElementById("cont").style.background = "#f4f6f5";
  document.getElementById("cont").style.backgroundImage = "none";
